...
可选工具
- https://api.oplist.org/ 由[OpenList Team](https://github.com/openlistteam)维护
- https://alist-docs.voidval.com/zh/tool/onedrive/request.html 由[NodeseekDev](https://github.com/nodeseekdev) 维护
...
将上一步骤中获得的 `client_id` 和 `client_secret` 填入 https://alist-docs.voidval.com/zh/tool/onedrive/request.html ，点击"获取刷新令牌"即可
